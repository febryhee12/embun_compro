        ...
        <form onSubmit={handleSubmit} className="p-5 sm:p-6 overflow-y-auto space-y-5">
          ...
          <div className="pt-3 border-t border-border/70 flex items-center justify-end gap-2.5">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="px-5 py-2.5 rounded-full bg-rose-600 hover:bg-rose-700 text-white font-bold text-xs shadow-md transition-all flex items-center gap-2 cursor-pointer disabled:opacity-60"
            >
