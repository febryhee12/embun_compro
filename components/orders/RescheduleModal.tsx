      ...
      <div className="w-full max-w-lg bg-white text-foreground rounded-t-3xl sm:rounded-3xl shadow-2xl border border-border max-h-[92vh] sm:max-h-[88vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <form onSubmit={handleSubmit} className="p-5 sm:p-6 overflow-y-auto space-y-5">
          ...
          <div className="space-y-2.5">
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full text-xs sm:text-sm px-4 py-3 rounded-2xl border border-border bg-white text-foreground focus:outline-none focus:ring-2 focus:ring-brand-blue/30 focus:border-brand-blue"
              />
            </div>
          ...
          {checkInStr && checkOutStr && (
            <div className="p-4 rounded-2xl bg-brand-blue/5 border border-brand-blue/20 space-y-1.5 text-xs">
            ...
            <>
              {quote.available ? (
                <div className="p-4 rounded-2xl bg-emerald-50/70 border border-emerald-200 space-y-3">
                  ...
                  <div className="space-y-2 pt-2 border-t border-emerald-200/60 text-xs text-foreground-muted">
                    ...
                    <div className="pt-2 border-t border-emerald-200 flex justify-between items-center text-foreground font-bold">
                      <span>
          ...
          <div className="pt-3 border-t border-border/70 flex items-center justify-end gap-2.5">
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-full bg-brand-blue hover:bg-brand-blue-hover text-white font-bold text-xs shadow-md transition-all flex items-center gap-2 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {submitting ? (
                <>
