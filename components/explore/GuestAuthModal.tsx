            ...
            <>
              <div className="space-y-2 text-center">
                ...
                <p className="text-xs text-foreground-muted max-w-xs mx-auto leading-relaxed">
                  Pilih akun untuk masuk, menyimpan spot favorit, dan melihat riwayat pemesanan.
                </p>
              </div>
              ...
              <div className="space-y-3 pt-2">
                ...
                <button
                  ...
                  className="w-full py-3.5 px-4 rounded-2xl border border-border bg-white hover:bg-surface text-foreground font-bold text-xs shadow-2xs hover:shadow-md transition-all flex items-center justify-center gap-3 cursor-pointer disabled:opacity-50"
                >
                ...
                <button
                  ...
                  disabled={loadingProvider !== null}
                  className="w-full py-3.5 px-4 rounded-2xl bg-black hover:bg-neutral-800 text-white font-bold text-xs shadow-md transition-all flex items-center justify-center gap-3 cursor-pointer disabled:opacity-50"
                >
              ...
              <p className="text-[10.5px] text-foreground-muted text-center leading-relaxed">
                Dengan melanjutkan, Anda menyetujui Ketentuan Layanan dan Kebijakan Privasi Embun.
              </p>
            </>
          )}
        </div>
