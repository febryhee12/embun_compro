        ...
        >
          {isEn ? (
            <>
              ...
              <p>
                Embun collects personal data that you provide directly when registering or
                using the Embun App or Website, including your full name, email address, and phone number.
              </p>
              <p>
                When you search for or book a campsite, Embun also collects location data you
                share to show nearby campsites, as well as transaction history such as booking details,
              ...
              <p>
                Embun automatically collects limited technical data, such as your IP address and
                the type of browser or device you use, for login session security (preventing account abuse)
                and to understand campsite page visit patterns in aggregate. The Embun App currently does not
                use third-party analytics or tracking services (like Firebase Analytics or Crashlytics)
                to collect your behavioral data.
              </p>

              <h2>Purpose of Data Collection</h2>
              <p>
                Embun uses your personal data to process campsite bookings, manage your account
                on the Embun App, and send communications regarding order or payment status.
              </p>
              <p>
                Embun also uses your personal data to contact prospective partners who fill out the
                Contact Form, provide customer support when you submit inquiries, and
                continuously improve the quality of the Embun App and Website services.
              </p>

              <h2>Data Retention Period</h2>
              <p>
                Embun stores your profile and account data for as long as your account remains actively used.
                Transaction and payment history data is retained longer in accordance with the period
                required by applicable laws and regulations in Indonesia, including taxation and accounting provisions,
                before ultimately being deleted or anonymized.
              </p>
              <p>
                If you request account deletion, Embun will delete or anonymize your personal data
                that is no longer legally required to be retained within a reasonable time after your request is verified.
              </p>

              <h2>Parties with Access to Your Data</h2>
              <p>
                Your personal data can be accessed by Embun's internal team responsible for managing
              ...
              <p>
                Embun also shares necessary transaction data with Midtrans as the payment gateway provider,
                to process your payments securely.
              </p>
              <p>
                Embun does not sell or rent your personal data to third parties for marketing purposes
                outside the context described in this policy.
              </p>

              <h2>Compliance with Personal Data Protection Law</h2>
              <p>
                Embun is committed to managing your personal data in accordance with the Personal Data Protection Law
                (UU PDP) No. 27 of 2022 applicable in Indonesia.
              </p>
              <p>
                As a personal data controller, Embun implements reasonable technical and organizational measures
                to protect your personal data from unauthorized access, disclosure, alteration, or deletion,
                in accordance with the principles set out in the UU PDP, including minimizing the purpose of
                data collection and processing to what is strictly necessary.
              </p>
              <p>
                You have rights guaranteed by the UU PDP over your personal data, including the right to know
                what data is collected, the right to correct inaccurate data, and the right to request
                the deletion of your personal data in accordance with applicable regulations.
              </p>

              <h2>User Age Limits</h2>
              <p>
                The Embun App and Website are intended for users who have met the legal age limit
                to conduct electronic transactions independently in Indonesia. Embun does not
                intentionally collect personal data from minors. If Embun discovers that a minor's
                personal data has been collected without the consent of a legal parent/guardian,
                Embun will delete such data as soon as possible.
              </p>

              <h2>Contact Us</h2>
              <p>
                If you have questions about this privacy policy or wish to submit a request to
                delete your personal data, please contact the Embun team via email{' '}
                <a href="mailto:help@embun.app">help@embun.app</a>.
              </p>
              <p>
                Embun will respond to your requests regarding personal data within a reasonable time
                in accordance with the applicable UU PDP provisions.
              </p>
            </>
          ) : (
            <>
